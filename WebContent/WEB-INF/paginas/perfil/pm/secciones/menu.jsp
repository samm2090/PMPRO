...
<div id="sidebar-left" class="span2">
	<div class="nav-collapse sidebar-nav">
		<ul class="nav nav-tabs nav-stacked main-menu">
			...
			<li><a href="#" class="btn-setting" ><i class="icon-plus-sign"></i><span class="hidden-tablet"> Nuevo Portafolio</span></a></li>
			<m:menuPortafolio/>
		</ul>
	</div>
</div>
...
<div class="modal hide fade" id="myModal">
	...
	<div class="modal-body">
		<form class="form-horizontal" action="<s:url action="registrarPortafolio" namespace="/portafolio" />" method="post" >
			<fieldset>
