...
public class MenuPortafolio extends TagSupport  {
		...
		try{
			...
			try{
				...
				for(int i=0;i<portafolios.size();i++){
					...
					out.println("<li onclick=\"location.href='/PMPRO/portafolio/infoPortafolio.action?portafolio.codigo="+portafolio.getCodigo()+"';\">"
					...
					for(int e=0; e<proyectos.size();e++){
						...
						out.println("<li><a class='submenu' href='/PMPRO/proyecto/infoProyecto.action?id1="+proyectos.get(e).getCodigo()+"&id2="+proyectos.get(e).getCodpportafolio()+"'>"+
